...
import DetailedProjectsView from '@/app/pages/projects/projects'; 
    ...
    >
      ...
      >
        ...
        <div className="lg:col-span-6 flex flex-col justify-end max-w-md">
          ...
          >
            A curated collection of scalable web ecosystems, optimized mobile structures, and clean database integrations driven by technical accuracy.
          </motion.p>
        </div>
      </motion.div>
    </PageCanvas>
...
//     <PageCanvas
//       activeRoute="projects"
//       gradientStyle="linear-gradient(135deg, #2c2c2e8c 0%, #0a0a0a 100%)"
//             bgImageUrl="/cover/cover3.jpg"
