  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="flex flex-col h-full justify-between pt-16 md:pt-40 pb-6 text-white"
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 md:mb-24">
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-5 flex flex-col justify-end lg:pb-4">
            <h2 className="text-2xl md:text-3xl font-semibold leading-snug max-w-md">
              Building Distinct Brands <span className="text-accent drop-shadow-[1px_1px_0_black]">Through Strategy & Design</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4 pt-10">
              <a 
                href="#projects" 
                className="inline-flex items-center gap-2 bg-accent text-white text-base font-semibold px-6 py-3.5 rounded-full hover:bg-accent/90 transition-all duration-200 shadow-lg active:scale-95 group"
              >
                View Services
              ...
              <a 
                href="#cv" 
                className="inline-flex items-center gap-2 border border-white/20 text-white text-base font-semibold px-6 py-3.5 rounded-full hover:bg-white/10 transition-all duration-200 active:scale-95"
              >
                Download CV
        ...
        >
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-extrabold tracking-tight text-accent">6+</span>
